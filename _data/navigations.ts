        ...
        items: [
            { text: 'Быстрый старт', link: '/quick-start' },
            {
                ...
                items: [
                    ...
                    {
                        text: 'Установка рядом с MacOS',
                        link: '/install-on-macbook-with-opencore-parallel'
                    }
                ],
                collapsed: true
            },
            {
                ...
                items: [
                    ...
                    { text: 'Туба', link: '/tuba' },
                    {
                        text: 'Центр мониторинга системы',
                        link: '/system-monitoring-center'
                    },
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {
                                text: 'Закрепить приложение в панели приложений',
                                link: '/add-apps-panel-tasks'
                            },
                            {
                                text: 'Открытие окон по центру экрана',
                                link: '/windows-in-the-center'
                            },
                            {
                                text: 'Автоматический запуск приложений',
                                link: '/startup-applications'
                            },
                            {
                                text: 'Быстрое переключение между окнами',
                                link: '/switching-apps'
                            },
                            {
                                text: 'Уведомления и список уведомлений',
                                link: '/notifications'
                            },
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    {
                                        text: 'Нужна ли мне антивирусная программа',
                                        link: '/net-antivirus'
                                    },
                                    {
                            ...
                            },
                            {
                                ...
                                items: [
                                    {
                                        text: 'Изменение используемого по умолчанию веб-браузера',
                                        link: '/net-browser'
                                    }
                                ],
                                collapsed: true
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                items: [
                                    {
                                        text: 'Использование других раскладок клавиатуры',
                                        link: '/keyboard-layouts'
                                    },
                            ...
                            },
                            {
                                ...
                                items: [
                                    {
                                        text: 'Общая тема для всех приложений',
                                        link: '/uniform-look'
                                    }
                                ],
                                collapsed: true
                            },
                            {
                                ...
                                items: [
                                    {
                                        text: 'Изменение разрешения или ориентация экрана',
                                        link: '/look-resolution'
                                    },
                                    {
                                        text: 'Подключение дополнительного монитора',
                                        link: '/display-dual-monitors'
                                    },
                                    {
                                        text: 'Масштабирование экрана',
                                        link: '/scaling-the-screen'
                                    },
                                    {
                                        text: 'Изменение внешнего вида рабочего стола',
                                        link: '/look-background'
                                    },
                                    {
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        text: 'AppIndicator/KStatusNotifierItem',
                    ...
                    {
                        text: 'EasyEffects Preset Selector',
                        link: '/easyeffects-preset-selector'
                    },
                    { text: 'GSConnect', link: '/gsconnect' },
                    {
                        text: 'Legacy (GTK3) Theme Scheme Auto Switcher',
                        link: '/legacy-theme-auto-switcher'
                    },
                    ...
                    {
                        text: 'Status Area Horizontal Spacing',
                        link: '/status-area-horizontal-spacing'
                    },
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        text: 'Проблема со звуком в передней панели',
                        link: '/fix-front-panel-audio'
                    },
                    {
                    ...
                    {
                        text: 'Использование клавиатур Дарк Проджект',
                        link: '/dark-project-keyboard-on-linux'
                    }
                ],
                collapsed: true
            },
